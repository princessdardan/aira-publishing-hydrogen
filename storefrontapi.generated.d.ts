...
export type CollectionCarouselFragment = Pick<
...
export type FeatureSectionsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type FeatureSectionsQuery = {
  metaobjects: {
    nodes: Array<
...
export type SubcollectionsQueryQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type SubcollectionsQueryQuery = {
...
export type ShopHeroQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ShopHeroQuery = {
  shop: Pick<StorefrontAPI.Shop, 'id' | 'name'> & {
    heroSection?: StorefrontAPI.Maybe<
...
export type SuggestedProductsQueryVariables = StorefrontAPI.Exact<{
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query FeatureSections($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    metaobjects(type: "feature_section", first: 10) {\n      nodes {\n        id\n        fields {\n          key\n          value\n          reference {\n            __typename\n            ... on MediaImage {\n              id\n              image {\n                url\n                altText\n                width\n                height\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: FeatureSectionsQuery;
    variables: FeatureSectionsQueryVariables;
  };
  '#graphql\n  fragment CollectionCarousel on Collection {\n    id\n    title\n    handle\n    image {\n      id\n      url\n      altText\n      width\n      height\n    }\n  }\n  query SubcollectionsQuery(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      id\n      handle\n      title\n      metafield(namespace: "custom", key: "subcollections") {\n        id\n        type\n        references(first: 20) {\n          nodes {\n            ... on Collection {\n              ...CollectionCarousel\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: SubcollectionsQueryQuery;
    variables: SubcollectionsQueryQueryVariables;
  };
  '#graphql\n  #graphql\n  fragment HeroSection on Metaobject {\n    id\n    type\n    fields {\n      key\n      value\n      reference {\n        __typename\n        ... on MediaImage {\n          id\n          image {\n            id\n            url\n            altText\n            width\n            height\n          }\n        }\n      }\n    }\n  }\n\n  query ShopHero($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    shop {\n      id\n      name\n      heroSection: metafield(namespace: "custom", key: "hero_section") {\n        id\n        type\n        value\n        reference {\n          ...HeroSection\n        }\n      }\n    }\n  }\n': {
    return: ShopHeroQuery;
    variables: ShopHeroQueryVariables;
  };
  '#graphql\n  query SuggestedProducts($first: Int!) {\n    products(first: $first, sortKey: BEST_SELLING) {\n      nodes {\n        ...ProductCard\n      }\n    }\n  }\n  #graphql\n  fragment ProductCard on Product {\n    id\n    title\n    handle\n    vendor\n    description\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    compareAtPriceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n  }\n\n': {
    return: SuggestedProductsQuery;
    variables: SuggestedProductsQueryVariables;
  };
